  ...
  return {
    ...
    verification: {
      ...
      other: {
        ...
        ...(process.env.FACEBOOK_VERIFICATION && { 'facebook-domain-verification': process.env.FACEBOOK_VERIFICATION }),
      },
    },
...
export const getPersonSchema = () => ({
  ...
  "description": "Thomas OTT, développeur full-stack freelance spécialisé en React, Next.js et TypeScript. Basé à Mulhouse, Grand Est, France.",
